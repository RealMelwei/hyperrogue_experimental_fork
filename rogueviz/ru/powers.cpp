...
power& power::is_starting() { qty_filled = qty_owned = 1; return selfhr; }

power& power::while_paused() { paused_act = act; dead_act = act; return selfhr; }

power& power::while_dead() { dead_act = act; return selfhr; }
