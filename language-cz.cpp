...
S("Embed Euclidean rectangular torus into hr_S3.", "Vnoř eukleidovský obdélníkový torus do hr_S3.")
...
S("error: currently works only in hr_PURE Euclidean regular square or hex tiling", "chyba: momentálně funguje pouze v ČISTÉM eukleidovském pravidelném čtvercovém nebo šestiúhelníkovém dláždění")
