...
EX namespace fake {
  ...
  EX bool available() {
    if(in()) return true;
    if(WDIM == 2 && standard_tiling() && (hr_PURE || BITRUNCATED)) return true;
    if(WDIM == 2 && standard_tiling() && GOLDBERG && hr_S3 == 4 && ((gp::param.first+gp::param.second) % 2)) return true;
    if(WDIM == 2 && standard_tiling() && GOLDBERG && hr_S3 == 3 && ((gp::param.first-gp::param.second) % 3)) return true;
    if(WDIM == 2 && standard_tiling() && GOLDBERG && hr_S3 == 4 && gp::param.first == 1 && gp::param.second == 1) return true;
    if(WDIM == 2 && standard_tiling() && UNRECTIFIED && hr_S3 == 4 && gp::param.first == 1 && gp::param.second == 1) return true;
    if(WDIM == 2 && standard_tiling() && UNTRUNCATED && hr_S3 == 3 && gp::param.first == 1 && gp::param.second == 1) return true;
    if(arcm::in() && hr_PURE) return true;
  ...
  struct hrmap_fake : hrmap {
    ...
    hyperpoint get_corner(cell *c, int cid, ld cf=3) override { 
      ...
      if(GOLDBERG && hr_S3 == 4 && gp::param.first == 1 && gp::param.second == 1) {
        return ddspin(c, cid) * spin(-M_PI / c->type) * lxpush0((c == c->master->c7 ? cgi.hexf : cgi.hexvdist) * 3 / cf);
        }

      if(UNRECTIFIED && hr_S3 == 4 && gp::param.first == 1 && gp::param.second == 1) {
    ...
    transmatrix adj(cell *c, int d) override {
      ...
      if(UNTRUNCATED && hr_S3 == 3 && gp::param.first == 1 && gp::param.second == 1) {
        c->cmove(d);
...
EX ld compute_euclidean() {
  ...
  if(WDIM == 2 && standard_tiling() && GOLDBERG && hr_S3 == 4 && gp::param.first == 1 && gp::param.second == 1)
    return S7 / (0.375 * S7 - 0.5);
  if(WDIM == 2 && standard_tiling() && UNRECTIFIED && hr_S3 == 4 && gp::param.first == 1 && gp::param.second == 1)
    return 4;
  if(WDIM == 2 && standard_tiling() && UNTRUNCATED && hr_S3 == 3 && gp::param.first == 1 && gp::param.second == 1)
    return 6;
...
EX ld around_orig() {
  ...
  if(WDIM == 2 && BITRUNCATED)
    return 3;
  if(WDIM == 2 && standard_tiling() && GOLDBERG && hr_S3 == 4 && gp::param.first == 1 && gp::param.second == 1) return 4;
  if(WDIM == 2 && standard_tiling() && UNRECTIFIED && hr_S3 == 4 && gp::param.first == 1 && gp::param.second == 1)
    return S7;
  if(WDIM == 2 && standard_tiling() && UNTRUNCATED && hr_S3 == 3 && gp::param.first == 1 && gp::param.second == 1)
    return S7;
