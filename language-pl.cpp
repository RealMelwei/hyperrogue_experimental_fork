...
S("Embed Euclidean rectangular torus into hr_S3.", "Zanurz prostokątny torus w geometrię sferyczną.")
...
S("error: currently works only in hr_PURE Euclidean regular square or hex tiling", "błąd: obecnie działa tylko w CZYSTYM parkietażu euklidesowym kwadratowym lub sześciokątnym")
